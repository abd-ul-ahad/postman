...
export class WebPanel {
  ...
  public static readonly viewType = "Postman";
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    const scriptUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "out/compiled", "mainTab.js")
    );
    ...
    const stylesMainUri = webview.asWebviewUri(
      vscode.Uri.joinPath(this._extensionUri, "media/css", "panel.css")
    );
